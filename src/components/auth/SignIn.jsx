...
import { googleAuthSlice, loginUser, togglePasswordVisibility } from "../../slice/authSlice";
      ...
      <div className="login-container">
        <div className="login-box">
          ...
          <form onSubmit={handleLoginUser}>
            <input type="email" placeholder="Email" name="email" value={auth?.email || ""} onChange={handleChange} className="input-field" />
            <input type={togglePassword.loginTogglePassword ? "text" : "Password"} placeholder="Password" name="password" value={auth?.password || ""} onChange={handleChange} className="input-field" />
